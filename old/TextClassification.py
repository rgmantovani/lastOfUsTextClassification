...
#função que exclui o termo associado
...
df = pd.read_csv("H:/IC_2023_2024/Datasets/critic_reviews_g1.csv")
df2 = pd.read_csv("H:/IC_2023_2024/Datasets/critic_reviews_lb.csv")
df3 = pd.read_csv("H:/IC_2023_2024/Datasets/critic_reviews_g2.csv")
df4 = pd.read_csv("H:/IC_2023_2024/Datasets/critic_reviews_g1u.csv")
df5 = pd.read_csv("H:/IC_2023_2024/Datasets/user_reviews_g1.csv")
df6 = pd.read_csv("H:/IC_2023_2024/Datasets/user_reviews_g2.csv")
df7 = pd.read_csv("H:/IC_2023_2024/Datasets/critic_reviews_g1u.csv")
df8 = pd.read_csv("H:/IC_2023_2024/Datasets/critic_reviews_g1u.csv")

obj = DatasetTratado(df, stops2, ['date'], 'review', "H:/IC_2023_2024/Datasets/ReviewTLOU1.csv")

#retornos e execução
obj2 = LimpaDataset(df5, 'English', 'H:/IC_2023_2024/Datasets/user_reviews_g1_created.csv')
dfaux = pd.read_csv('H:/IC_2023_2024/Datasets/user_reviews_g1_created.csv')
obj2 = DatasetTratado(dfaux, stops2, ['date'], 'review', "H:/IC_2023_2024/Datasets/UserTLOU1.csv")

print(obj2[0])
obj2[0].to_csv('H:/IC_2023_2024/Datasets/relevant.csv')
obj2[1].to_csv('H:/IC_2023_2024/Datasets/relevant11.csv')
obj3 = LimpaDataset(df6, 'English', 'H:/IC_2023_2024/Datasets/user_reviews_g2_created.csv')
dfaux2 = pd.read_csv('H:/IC_2023_2024/Datasets/user_reviews_g2_created.csv')
obj3 = DatasetTratado(dfaux2, stops2, ['date'], 'review', "H:/IC_2023_2024/Datasets/exemploFuncUsr.csv")
obj3[0].to_csv('H:/IC_2023_2024/Datasets/relevant2.csv')
obj3[1].to_csv('H:/IC_2023_2024/Datasets/relevant22.csv')
#metodos de extração da feature
#bag of words
def bagOfWords(text):
...
feattest = featureExtraction(obj2[0], obj2[1], 'review')
ft1 = feattest[0]
ft2 = feattest[1]

feattest2 = featureExtraction(obj3[0], obj3[1], 'review')
ft1_2 = feattest2[0]
ft2_2 = feattest2[1]
